...
#'   \item{percent_males}{% Males}
#'   \item{percent_females}{% Females}
#'   \item{percent_direct_certification}{% Direct Certification}
#'   \item{percent_swd}{% Students with Disabilities (SWD)}
#'   \item{percent_el}{% English Learner (EL)}
#'   \item{percent_non_hispanic_black}{% Non-Hispanic Black}
#'   \item{percent_non_hispanic_white}{% Non-Hispanic White}
#'   \item{percent_hispanic}{% Hispanic}
#'   \item{percent_non_hispanic_asian}{% Non-Hispanic Asian}
#'   \item{percent_non_hispanic_american_indian}{% Non-Hispanic American Indian}
#'   \item{percent_non_hispanic_pacific_islander}{% Non-Hispanic Pacific Islander}
#'   \item{percent_non_hispanic_multiracial}{% Non-Hispanic Multiracial}
#' }
#' @source \url{https://www.baltimorecityschools.org/sites/default/files/inline-files/SY19-20-Enrollment-11.10.2020.xlsx}
...
#'   \item{share}{% of Total Enrollment}
...
#'   \item{estimated_parent_number_eligible}{Estimated number of eligible parents}
#'   \item{estimated_parent_response_rate}{Estimate parent response rate}
...
#' }
#' @source \url{https://www.baltimorecityschools.org/sites/default/files/inline-files/SY18-19%20Parent%20School%20Survey%20OFFICIAL.xlsx}
"parent_school_survey_SY1819"
...
#'   \item{estimated_parent_number_eligible}{Estimated number of eligible parents}
#'   \item{estimated_parent_response_rate}{Estimated parent response rate}
...
#' }
#' @source \url{https://www.baltimorecityschools.org/sites/default/files/inline-files/SY18-19%20Parent%20School%20Survey%20OFFICIAL.xlsx}
"parent_school_survey_SY1819_long"
