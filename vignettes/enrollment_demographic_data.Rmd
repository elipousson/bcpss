...
Baltimore City Public Schools provides data on total enrollment and selected demographic characteristics by grade and grade range for all schools. The data included in this package is imported from the original Excel file. You can see the import process by looking at the [`bcps_data.R`](https://github.com/elipousson/bcps/blob/master/data-raw/bcps_data.R) on the bcps GitHub repo.
